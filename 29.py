...
Output:
Enter the names of the features separated by commas: petal length (cm),petal width (cm)
Enter the name of the target variable(setosa, versicolor, virginica): setosa
Accuracy: 1.00
Precision: 1.00
Recall: 1.00
F1-score: 1.00
